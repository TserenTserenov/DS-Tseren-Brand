...
> Учёт всех коротких видео: идея → записано → опубликовано. Сценарии - в [`ideas/`](ideas/). Стиль - [`../style/video.md`](../style/video.md) (наследует канон [`../style/post.md`](../style/post.md)). Шаблон съёмки - [`script-template.md`](script-template.md).
>
> **Разметка по контент-системе** (определения - в брендките `DS-Tseren-Brand/08-content-themes.md`):
> **Область** О1 Личное · О2 Спорт · О3 Путешествия · О4 Развитие и мышление · О5 Дело · О6 Смысл. **Ипостась** И1 Человек · И2 Практик · И3 Методолог · И4 Просветитель · И5 Строитель · И6 Визионер. **Формат** ОБЪ объяснение · ИСТ история · РАЗВ разворот · РАЗБ разбор · СОВ совет. **ИИ** да/нет.
>
...
|------|---|---|--------|----|----|--------|----------|
| Заземление (прогулка) | О4 | И4 | ОБЪ | нет | 🎬 _дата_ | — | [zazemlenie-progulka](ideas/2026-06-25-zazemlenie-progulka.md) |
| Класс или вещь (ноутбук) | О4 | И4 | ОБЪ | нет | 🎬 _дата_ | — | [klass-ili-vesch](ideas/2026-06-25-klass-ili-vesch.md) |
| Два в одном (мама) | О4 | И4 | ОБЪ | нет | 🎬 _дата_ | — | [dva-v-odnom-rol](ideas/2026-06-25-dva-v-odnom-rol.md) |
| Стоп-момент | О4 | И2 | СОВ | нет | 🎬 _дата_ | — | [stop-moment](ideas/2026-06-23-stop-moment.md) |
| ИИ: экзоскелет или автопилот | О4 | И4 | РАЗВ | да | 🎬 _дата_ | — | [ii-ekzoskelet-avtopilot](ideas/2026-06-19-ii-ekzoskelet-avtopilot.md) |
| Рывок - это ловушка | О4 | И2 | РАЗВ | нет | 🎬 _дата_ | — | [ryvok-lovushka](ideas/2026-06-19-ryvok-lovushka.md) |
